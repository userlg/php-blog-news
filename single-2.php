...
<body>
            ...
            <div class="row">
                <div class="col-12">
                    <ol class="bn-breadcrumb">
                        ...
                        <li><i class="fa fa-angle-right"></i>Do not give up..</li>
                    </ol>
                </div>
                <!-- Col End -->
            </div>
    ...
    <section class="main-content pt-0">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="bn-entry-header">
                        <div class="post-thumb thumb-fullwidth">
                            <a href="assets/images/1110x731.png" class="gallery-popup cboxElement">
                            <img class="img-fluid" src="assets/images/1110x731.png" alt="">
                        </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-8 col-md-12">
                    <div class="bn-single-post">
                        <div class="bn-single-post-header">
                            <h2 class="bn-post-title title-lg">Do not give up. The beginning is always the hardest</h2>
                            <ul class="bn-post-meta">
                                <li class="bn-post-author">
                                    <a href="#"><img alt="" src="assets/images/100x100.png"><strong>James Bond</strong></a>
                                </li>
                                <li>
                                    <a href="#"><i class="far fa-clock"></i> 26 Jan, 2021</a>
                                </li>
                                <li>
                                    <a href="#"><i class="fa fa-comments"></i>5 Comments</a>
                                </li>
                                <li>
                                    <a href="#" class="view"><i class="fab fa-gripfire"></i> 354k</a>
                                </li>
                                <li>
                        ...
                        <div class="bn-single-post-content">
                            <p><span class="bn-dropcap">T</span>rue friendship is perhaps the only relation that survives the trials and tribulations of time and remains unconditional. A unique blend of affection, loyalty, love, respect, trust and loads of fun is perhaps what describes the true meaning of friendship.</p>
                            <p>Similar interests, mutual respect and strong attachment with each other are what friends share between each other.
                                <a href="#">These are just the general traits of a friendship.</a> To experience what is friendship, one must have true friends, who are indeed rare treasure.
                            </p>
                            <p>Friendship is a feeling of comfort and emotional safety with a person. It is when you do not have to weigh your thoughts and measure words, before keeping it forth before your friend.</p>
                            <p>
                                <img class="float-left img-fluid" src="assets/images/300x406.png" alt="">
                            </p>
                            <h3>What is a friend? A single soul, dwelling in two bodies</h3>
                            <p>
                                It is when someone knows you better than yourself and assures to be your side in every emotional crisis.
                                It is when you can sleep fighting and get another morning with a better understanding.
                            </p>
                            <p>
                            ...
                            <p>People form definitions based on the kind of experiences they have had. This is one relation that has been nurtured since time immemorial. There are famous stories about friends in mythologies of different religions all over the world. They say a person who has found a faithful friend has found a priceless treasure.</p>
                            <div class="bn-post-video">
                                <img class="img-fluid" src="assets/images/800x520.png" alt="">
                                <div class="bn-post-video-content">
                                    <a href="https://www.youtube.com/embed/9ZOhQTF0G0c?autoplay=1&amp;loop=1" class="popup cboxElement bn-play-btn">
                                        <i class="fa fa-play" aria-hidden="true"></i>
                                    </a>
                                    <h3>
                                        <a href=""> Psychologically speaking, friendship may be defined as ‘a dynamic, mutual relationship between two individuals.</a>
                                    </h3>
                                </div>
                            </div>
                            <h3>
                                As children become friends, they negotiate boundaries within which both partners function’.
                            </h3>
                            <p>
                                This helps them to function like healthy individuals in life as they learn to draw a line as and when needed in a relation. This greatly helps in the emotional development of an individual. However, any relation needs constant nurturing and development from all the people that are involved in one.
                            </p>
                            <p>
                                <a href="#">
                                    <img class="img-fluid" src="assets/images/800x520.png" alt="">
                            ...
                            <h3>Friendship cannot survive if one person makes all the effort to sustain it without any mutual recognition from others.</h3>
                            <ul>
                                <li>Since friendship starts the moment a child starts socializing</li>
                                <li>the kind of friends that the child chooses should be taken care</li>
                                <li>he / she learns to differentiate between right and wrong chooses.</li>
                                <li>Wrong peers or lack of socializing can lead to severe psychological</li>
                            </ul>
                            <p>finally leading to social maladjustment. The correct peer group is essential for the development of the personality of a child. Both positive and negative experiences refine the personality of the individual. Thus it is essential that you find friends who are compatible with you on an emotional and psychological basis.</p>
                        </div>
